<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/329591/ultimate-railroads" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Helmut Ohley, Leonhard "Lonny" Orgler</dd>
        <dt>Graphics design</dt>
        <dd>Martin Hoffmann, Claus Stephan</dd>
        <dt>Publisher</dt>
        <dd><a href="https://www.hans-im-glueck.de/" target="_blank" rel="noopener">Hans im Glück</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/ultimate-railroads-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/ultimate-railroads-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/ultimate-railroads-solo-helper</a></dd>
      </dl>
    </template>
  </ModalDialog>
